...
TEST_F(TestInertia2, CanInstantiate)
{
    ...
    EXPECT_DOUBLE_EQ( inertia.getTimeConst1(), 0.0 );
    EXPECT_DOUBLE_EQ( inertia.getTimeConst2(), 0.0 );
...
TEST_F(TestInertia2, CanInstantiateAndSetData)
{
    ...
    EXPECT_DOUBLE_EQ( inertia.getTimeConst1(), 2.0 );
    EXPECT_DOUBLE_EQ( inertia.getTimeConst2(), 3.0 );
    EXPECT_DOUBLE_EQ( inertia.getValue(), 4.0 );
}
