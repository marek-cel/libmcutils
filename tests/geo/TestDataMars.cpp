...
TEST_F(TestDataMars, IsEllipsoidFlatteningCorrect)
{
    ...
    // tests/geo/octave/test_geo_data_mars.m
    EXPECT_NEAR( mc::DataMars::f, 0.0058860075555255, 1.0e-12 );
}
...
TEST_F(TestDataMars, IsMeanRadiusCorrect)
{
    // calculated with GNU Octave
    // tests/geo/octave/test_geo_data_mars.m
    EXPECT_NEAR( mc::DataMars::r1, 3389526.67, 1.0 );
}
...
TEST_F(TestDataMars, IsEllipsoidFirstEccentricitySquaredCorrect)
{
    // calculated with GNU Octave
    // tests/geo/octave/test_geo_data_mars.m
    EXPECT_NEAR( mc::DataMars::e2, 0.0117373700261072, 1.0e-12 );
}
...
TEST_F(TestDataMars, IsEllipsoidSecondEccentricityCorrect)
{
    // calculated with GNU Octave
    // tests/geo/octave/test_geo_data_mars.m
    EXPECT_NEAR( mc::DataMars::ep, 0.1089806042142403, 1.0e-12 );
}
