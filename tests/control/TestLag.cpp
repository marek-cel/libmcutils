...
TEST_F(TestLag, CanCalculate)
{
    ...
    XcosBinFileReader::readData( "../tests/control/data/test_lag_step.bin", &vals );
...
TEST_F(TestLag, CanCalculate2)
{
    ...
    CsvFileReader::readData( "../tests/control/data/test_lag_step.csv", &t_ref, &y_ref );
...
TEST_F(TestLag, CanUpdateSine)
{
    ...
    // expected values calculated with Scilab Xcos
    // tests/control/xcos/test_lag.xcos
    XcosBinFileReader::readData( "../tests/control/data/test_lag_sine.bin", &vals );
