...
TEST_F(TestHighPassFilter, CanUpdateStep)
{
    ...
    // tests/control/xcos/test_hpf.xcos
    XcosBinFileReader::readData( "../tests/control/data/test_hpf_step.bin", &vals );
...
TEST_F(TestHighPassFilter, CanUpdateSine)
{
    ...
    // expected values calculated with Scilab Xcos
    // tests/control/xcos/test_hpf.xcos
    XcosBinFileReader::readData( "../tests/control/data/test_hpf_sine.bin", &vals );
