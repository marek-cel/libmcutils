...
TEST_F(TestLowPassFilter, CanUpdateStep)
{
    ...
    // tests/control/xcos/test_lpf.xcos
    XcosBinFileReader::readData( "../tests/control/data/test_lpf_step.bin", &vals );
...
TEST_F(TestLowPassFilter, CanUpdateSine)
{
    ...
    // expected values calculated with Scilab Xcos
    // tests/control/xcos/test_lpf.xcos
    XcosBinFileReader::readData( "../tests/control/data/test_lpf_sine.bin", &vals );
