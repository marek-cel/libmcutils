...
TEST_F(TestPID, CanUpdate)
{
    ...
    XcosBinFileReader::readData( "../tests/control/data/test_pid.bin", &vals );
...
TEST_F(TestPID, CanUpdateAntiwindupCalculation)
{
    ...
    // expected values calculated with Scilab Xcos
    // tests/control/xcos/test_pid.xcos
    XcosBinFileReader::readData( "../tests/control/data/test_pid_antiwindup_calculation.bin", &vals );
...
TEST_F(TestPID, CanUpdateAntiwindupConditional)
{
    ...
    // expected values calculated with Scilab Xcos
    // tests/control/xcos/test_pid.xcos
    XcosBinFileReader::readData( "../tests/control/data/test_pid_antiwindup_conditional.bin", &vals );
...
TEST_F(TestPID, CanUpdateAntiwindupFilter)
{
    ...
    // expected values calculated with Scilab Xcos
    // tests/control/xcos/test_pid.xcos
    XcosBinFileReader::readData( "../tests/control/data/test_pid_antiwindup_filter.bin", &vals );
