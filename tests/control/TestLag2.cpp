...
TEST_F(TestLag2, CanUpdateStep)
{
    ...
    XcosBinFileReader::readData( "../tests/control/data/test_lag2_step.bin", &vals );
...
TEST_F(TestLag2, CanUpdateStep2)
{
    ...
    CsvFileReader::readData( "../tests/control/data/test_lag2_step.csv", &t_ref, &y_ref );
...
TEST_F(TestLag2, CanUpdateSine)
{
    ...
    // expected values calculated with Scilab Xcos
    // tests/control/xcos/test_lag2.xcos
    XcosBinFileReader::readData( "../tests/control/data/test_lag2_sine.bin", &vals );
